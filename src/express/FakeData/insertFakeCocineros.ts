import { cocineroService } from "../models";
...
const fakeCocineros = [
  {
    ...
    nombres: "Nombre Cocinero 1",
    apellidos: "Apellido Cocinero 1",
    ci: "12345678",
    fecha_nac: "1990-01-01",
    telefono: "1234567890",
    direccion_de_habitacion: "Dirección de Habitación 1",
    correo_electronico: "cocinero1@example.com",
    fecha_ingreso_mppe: "2020-01-01",
    anos_servicio: 5,
    titulo_obtenido: "Título Cocinero 1",
    codigo_cargo: "C001",
  ...
  },
  {
    ...
    nombres: "Nombre Cocinero 2",
    apellidos: "Apellido Cocinero 2",
    ci: "87654321",
    fecha_nac: "1985-05-05",
    telefono: "0987654321",
    direccion_de_habitacion: "Dirección de Habitación 2",
    correo_electronico: "cocinero2@example.com",
    fecha_ingreso_mppe: "2015-05-05",
    anos_servicio: 10,
    titulo_obtenido: "Título Cocinero 2",
    codigo_cargo: "C002",
  ...
  },
  {
    ...
    nombres: "Nombre Cocinero 3",
    apellidos: "Apellido Cocinero 3",
    ci: "11223344",
    fecha_nac: "1980-10-10",
    telefono: "1122334455",
    direccion_de_habitacion: "Dirección de Habitación 3",
    correo_electronico: "cocinero3@example.com",
    fecha_ingreso_mppe: "2010-10-10",
    anos_servicio: 15,
    titulo_obtenido: "Título Cocinero 3",
    codigo_cargo: "C003",
  ...
  },
  {
    ...
    nombres: "Nombre Cocinero 4",
    apellidos: "Apellido Cocinero 4",
    ci: "55667788",
    fecha_nac: "1975-07-07",
    telefono: "2233445566",
    direccion_de_habitacion: "Dirección de Habitación 4",
    correo_electronico: "cocinero4@example.com",
    fecha_ingreso_mppe: "2005-07-07",
    anos_servicio: 20,
    titulo_obtenido: "Título Cocinero 4",
    codigo_cargo: "C004",
  ...
  },
  {
    ...
    nombres: "Nombre Cocinero 5",
    apellidos: "Apellido Cocinero 5",
    ci: "99887766",
    fecha_nac: "1970-12-12",
    telefono: "3344556677",
    direccion_de_habitacion: "Dirección de Habitación 5",
    correo_electronico: "cocinero5@example.com",
    fecha_ingreso_mppe: "2000-12-12",
    anos_servicio: 25,
    titulo_obtenido: "Título Cocinero 5",
    codigo_cargo: "C005",
...
const insertFakeCocineros = async () => {
  try {
    for (const cocinero of fakeCocineros) {
      await cocineroService.createCocinero(cocinero);
    }
    console.log("Datos ficticios de cocineros insertados correctamente");
  } catch (error) {
    console.error("Error al insertar datos ficticios de cocineros:", error);
  }
};

export default insertFakeCocineros;