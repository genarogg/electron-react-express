...
const fakeDocentes = [
  {
    ...
    nombres: "Nombre Docente 1",
    apellidos: "Apellido Docente 1",
    ci: "12345678",
    fecha_nac: "1990-01-01",
    correo: "docente1@example.com",
    fecha_ingreso_mppe: "2020-01-01",
    anos_servicio: 5,
    titulo_pregrado: "Título Pregrado 1",
    funcion: "Función 1",
    area_docente_especialista: "Área Especialista 1",
    codigo_cargo: "C001",
    dependencia_nominal: "Dependencia Nominal 1",
    grado_seccion: "Grado 1",
    estatus: "Activo",
  ...
  },
  {
    ...
    nombres: "Nombre Docente 2",
    apellidos: "Apellido Docente 2",
    ci: "87654321",
    fecha_nac: "1985-05-05",
    correo: "docente2@example.com",
    fecha_ingreso_mppe: "2015-05-05",
    anos_servicio: 10,
    titulo_pregrado: "Título Pregrado 2",
    funcion: "Función 2",
    area_docente_especialista: "Área Especialista 2",
    codigo_cargo: "C002",
    dependencia_nominal: "Dependencia Nominal 2",
    grado_seccion: "Grado 2",
    estatus: "Activo",
    reposo_permiso: "Ninguno",
    inscrito_psuv: "Sí",
    pertenece_movimiento_social: "Sí",
  ...
  },
  {
    ...
    nombres: "Nombre Docente 3",
    apellidos: "Apellido Docente 3",
    ci: "11223344",
    fecha_nac: "1980-10-10",
    correo: "docente3@example.com",
    fecha_ingreso_mppe: "2010-10-10",
    anos_servicio: 15,
    titulo_pregrado: "Título Pregrado 3",
    funcion: "Función 3",
    area_docente_especialista: "Área Especialista 3",
    codigo_cargo: "C003",
    dependencia_nominal: "Dependencia Nominal 3",
    grado_seccion: "Grado 3",
    estatus: "Activo",
    reposo_permiso: "Ninguno",
    inscrito_psuv: "Sí",
    pertenece_movimiento_social: "Sí",
  ...
  },
  {
    ...
    nombres: "Nombre Docente 4",
    apellidos: "Apellido Docente 4",
    ci: "55667788",
    fecha_nac: "1975-07-07",
    correo: "docente4@example.com",
    fecha_ingreso_mppe: "2005-07-07",
    anos_servicio: 20,
    titulo_pregrado: "Título Pregrado 4",
    funcion: "Función 4",
    area_docente_especialista: "Área Especialista 4",
    codigo_cargo: "C004",
    dependencia_nominal: "Dependencia Nominal 4",
    grado_seccion: "Grado 4",
    estatus: "Activo",
    reposo_permiso: "Ninguno",
    inscrito_psuv: "Sí",
    pertenece_movimiento_social: "Sí",
  ...
  },
  {
    ...
    nombres: "Nombre Docente 5",
    apellidos: "Apellido Docente 5",
    ci: "99887766",
    fecha_nac: "1970-12-12",
    correo: "docente5@example.com",
    fecha_ingreso_mppe: "2000-12-12",
    anos_servicio: 25,
    titulo_pregrado: "Título Pregrado 5",
    funcion: "Función 5",
    area_docente_especialista: "Área Especialista 5",
    codigo_cargo: "C005",
    dependencia_nominal: "Dependencia Nominal 5",
    grado_seccion: "Grado 5",
    estatus: "Activo",
    reposo_permiso: "Ninguno",
    inscrito_psuv: "Sí",
    pertenece_movimiento_social: "Sí",
...
const insertFakeDocentes = async () => {
  try {
    for (const docente of fakeDocentes) {
      await docenteService.createDocente(docente);
    }
    console.log("Datos ficticios de docentes insertados correctamente");
  } catch (error) {
    console.error("Error al insertar datos ficticios de docentes:", error);
  }
};

export default insertFakeDocentes;
