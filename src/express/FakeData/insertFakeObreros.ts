...
const fakeObreros = [
  {
    ...
    nombres: "Nombre Obrero 1",
    apellidos: "Apellido Obrero 1",
    ci: "12345678",
    acarigua: "Acarigua 1",
    fecha_nac: "1990-01-01",
    telefono: "1234567890",
    direccion_de_habitacion: "Dirección de Habitación 1",
    correo_electronico: "obrero1@example.com",
    fecha_ingreso_mppe: "2020-01-01",
    anos_servicio: 5,
    titulo_obtenido: "Título Obrero 1",
    codigo_cargo: "C001",
  ...
  },
  {
    ...
    nombres: "Nombre Obrero 2",
    apellidos: "Apellido Obrero 2",
    ci: "87654321",
    acarigua: "Acarigua 2",
    fecha_nac: "1985-05-05",
    telefono: "0987654321",
    direccion_de_habitacion: "Dirección de Habitación 2",
    correo_electronico: "obrero2@example.com",
    fecha_ingreso_mppe: "2015-05-05",
    anos_servicio: 10,
    titulo_obtenido: "Título Obrero 2",
    codigo_cargo: "C002",
  ...
  },
  {
    ...
    nombres: "Nombre Obrero 3",
    apellidos: "Apellido Obrero 3",
    ci: "11223344",
    acarigua: "Acarigua 3",
    fecha_nac: "1980-10-10",
    telefono: "1122334455",
    direccion_de_habitacion: "Dirección de Habitación 3",
    correo_electronico: "obrero3@example.com",
    fecha_ingreso_mppe: "2010-10-10",
    anos_servicio: 15,
    titulo_obtenido: "Título Obrero 3",
    codigo_cargo: "C003",
  ...
  },
  {
    ...
    nombres: "Nombre Obrero 4",
    apellidos: "Apellido Obrero 4",
    ci: "55667788",
    acarigua: "Acarigua 4",
    fecha_nac: "1975-07-07",
    telefono: "2233445566",
    direccion_de_habitacion: "Dirección de Habitación 4",
    correo_electronico: "obrero4@example.com",
    fecha_ingreso_mppe: "2005-07-07",
    anos_servicio: 20,
    titulo_obtenido: "Título Obrero 4",
    codigo_cargo: "C004",
  ...
  },
  {
    ...
    nombres: "Nombre Obrero 5",
    apellidos: "Apellido Obrero 5",
    ci: "99887766",
    acarigua: "Acarigua 5",
    fecha_nac: "1970-12-12",
    telefono: "3344556677",
    direccion_de_habitacion: "Dirección de Habitación 5",
    correo_electronico: "obrero5@example.com",
    fecha_ingreso_mppe: "2000-12-12",
    anos_servicio: 25,
    titulo_obtenido: "Título Obrero 5",
    codigo_cargo: "C005",
...
const insertFakeObreros = async () => {
  try {
    for (const obrero of fakeObreros) {
      await obreroService.createObrero(obrero);
    }
    console.log("Datos ficticios de obreros insertados correctamente");
  } catch (error) {
    console.error("Error al insertar datos ficticios de obreros:", error);
  }
};

export default insertFakeObreros;